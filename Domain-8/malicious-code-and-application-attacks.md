...
* [Malicious Code](#malicious-code)
   ...
   * [Platforms Vulnerable to Viruses](#platforms-vulnerable-to-viruses)
   * [Antivirus Mechanisms](#antivirus-mechanisms)
...
* [Application Security](#application-security)
   ...
   * [Time of check to time to use (TOCTTOU or TOC/TOU)](#time-of-check-to-time-to-use-tocttou-or-toctou)
